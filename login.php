...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if ($result->num_rows > 0) {
    ...
    if (password_verify($password, $user['password'])) {
      ...
      $passFailMessage = "<div class='errorCenter'>The username or password you entered was not valid.</div>";
    }
  } else {
...
<body>
  ...
  <form method="post" action="login.php">
    ...
    <?php if ($passFailMessage) {
      echo $passFailMessage;
    } ?>
